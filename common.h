...
enum CODES
{
	...
	//expressions
	//Logical
	NT_LOGICAL_EXPR, NT_OR_EXPR, NT_AND_EXPR, NT_EQUALITY_EXPR, NT_RELATIONAL_EXPR, NT_LOGICAL_POSTFIX_EXPRESSION, NT_LOGICAL_PRIMARY_EXPR,
	//Arithmetic
	NT_ARITHMETIC_EXPR, NT_CONSTANT_EXPR, NT_SHIFT_EXPRESSION, NT_ADDITIVE_EXPR, NT_MULTIPLICATIVE_EXPR, NT_ARITHMETIC_POSTFIX_EXPR, NT_ARITHMETIC_PRIMARY_EXPR, 
	//Shared
