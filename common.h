...
enum CODES
{
	...
	CODE_BYTE, CODE_WORD, CODE_PTR, CODE_FIXED, CODE_LABEL, CODE_BYTEARRAY, CODE_WORDARRAY, CODE_TYPE,
	CODE_STACK, CODE_HEAP, //drop
	CODE_REPEAT, CODE_UNTIL, CODE_WHILE, CODE_FOR,
	CODE_IF, CODE_ELSE, CODE_EQ, CODE_NEQ, CODE_LT, CODE_GT, CODE_LE, CODE_GE, //drop
	//instructions
	...
	//statements
	NT_COMPOUND_STMT, NT_STMT, NT_OPEN_STMT, NT_CLOSED_STMT, NT_SIMPLE_STMT, NT_SELECTION_CLAUSE,
	...
	//expressions
	//Logical
	NT_LOGICAL_EXPR, NT_OR_EXPR, NT_AND_EXPR, NT_EQUALITY_EXPR, NT_RELATIONAL_EXPR, NT_LOGICAL_UNARY_EXPR, NT_LOGICAL_POSTFIX_EXPRESSION, NT_LOGICAL_PRIMARY_EXPR,
	//Arithmetic
	NT_ARITHMETIC_EXPR, NT_ADDITIVE_EXPR, NT_MULTIPLICATIVE_EXPR, MATH_UNARY_EXPR, 
	//Shared
	NT_POSTFIX_EXPR, NT_PRIMARY_EXPR,
